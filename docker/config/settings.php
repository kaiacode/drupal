 ...
 * @endcode
 */
$settings['hash_salt'] = 'GvSUGgm9W7iZu-IzO_5evN02smEq6MoslPDrooWd1xlJCrFYbTP-cAnjoY9SHQXDdv6z-D3wMA';
...
$settings['reverse_proxy_addresses'] = [
  getenv('REVERSE_PROXY_ADDRESS1'),
  getenv('REVERSE_PROXY_ADDRESS2'),
  getenv('REVERSE_PROXY_ADDRESS3'),
];
...
/**
 * Additional trusted host via environment variable.
 */
if (!empty(getenv('TRUSTED_HOST_PATTERN_ADDITIONAL'))) {
  $settings['trusted_host_patterns'][] = getenv('TRUSTED_HOST_PATTERN_ADDITIONAL');
}
...
/**
 * Custom translation directory for drush_language module.
 ...
 */
$settings['SITE_ENVIRONMENT'] = getenv('ENV');
 ...
 *
 * Only add specific cache bins to avoid filling too much data in memcached.
 * Otherwise, too many cache entries are evicted and we loose the performance boost.
 */
/**
 * Redis config
 */
